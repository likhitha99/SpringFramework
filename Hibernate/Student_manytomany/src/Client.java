...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Student stu1 = new Student(1, "Likhitha", "Ch", teachers);
			Student stu2 = new Student(2, "Lucy", "Hale", teachers);
			students.add(stu1);
			students.add(stu2);

			Teacher tch1 = new Teacher(1, "Jennifer", "Anniston", students);
			Teacher tch2 = new Teacher(2, "Rob", "jane", students);
			teachers.add(tch1);
			teachers.add(tch2);
