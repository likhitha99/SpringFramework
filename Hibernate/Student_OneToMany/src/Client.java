...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			students.add(new Student(1, "Likhitha", "Ch", "IBGT"));
			students.add(new Student(3, "joe", "D", "HR"));
			students.add(new Student(4, "jane", "D", "Tech"));
			College college = new College(1, "GRIET", "Bachupally", students);
